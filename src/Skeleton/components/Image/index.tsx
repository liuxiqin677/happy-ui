...
const ImageComponent: FC<SkeletonImageProps> = ({ active = false }) => {
  const skeletonImageWrapperClass = useMemo(() => {
    return cs({
      'happy-skeleton-image': true,
      'happy-skeleton-image-active': active,
    });
  }, [active]);

  return (
    <div className="happy-skeleton happy-skeleton-element">
      <div className={skeletonImageWrapperClass}>
        <svg
          viewBox="0 0 1098 1024"
          xmlns="http://www.w3.org/2000/svg"
          className="happy-skeleton-image-svg"
        >
          <path
            className="happy-skeleton-image-path"
