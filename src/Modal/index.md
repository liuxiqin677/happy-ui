...
| className         | string                                                                                                               | -         | false | 弹窗 className              |
...
| closeIcon         | boolean、ReactNode                                                                                                   | true      | false | 右上角弹窗关闭 icon         |
| confirmLoading    | boolean                                                                                                              | false     | false | ok 按钮的 loading           |
...
Modal 组件的实现也不算难，这里主要说我认为需要说明的几个点
